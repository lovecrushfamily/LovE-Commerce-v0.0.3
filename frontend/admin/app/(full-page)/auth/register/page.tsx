				...
				>
					<div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
						<div className="text-center mb-5">
							...
							<span className="text-600 font-medium">Register to become new customer!</span>
						</div>
						...
						<div>
							...
							<Button label="Register" className="w-full p-3 text-xl" onClick={() => router.push('/api')}></Button>
						</div>
					</div>
				</div>
			</div>
