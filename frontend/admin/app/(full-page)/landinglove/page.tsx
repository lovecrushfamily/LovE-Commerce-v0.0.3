            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        <img src={`./layout/images/crush.png`} alt="Sakai Logo" height="50" className="mr-0 lg:mr-2" />
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">LovEcommerce</span>
                    </Link>
                    ...
                    <div className={classNames('align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2', { hidden: isHidden })} style={{ top: '100%' }}>
                        ...
                        <div className="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                            ...
                            <Button onClick={() => window.location.href = "/auth/login"} label="Login" text rounded className="border-none font-light line-height-2 text-blue-500"></Button>
                            <Button onClick={() => window.location.href = "/auth/register"} label="Register" rounded className="border-none ml-5 font-light line-height-2 bg-blue-500 text-white"></Button>
                        </div>
                    </div>
                </div>          
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        <h1 className="text-6xl font-bold text-gray-900 line-height-2">
                            <span className='font-normal'>Welcome to home, Sir. LoveCrush</span>
                        </h1>
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Looking for new thing would never be bore</p>
                        <Button type="button" label="Learn more" rounded className="text-xl border-none mt-3 bg-blue-500 font-italic line-height-3 px-3 text-white"></Button>
                    </div>
                ...
                {/* <div id="features" className="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                    <div className="grid justify-content-center">
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-italic mb-2">Marvelous Features</h2>
                    ...
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <Link href="/" className="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                                <img src={`./demo/images/crush.png`} alt="footer sections" width="50" height="50" className="mr-2" />
                                <span className="font-medium text-3xl text-900">LovEcommerce</span>
                            </Link>
                        </div>
